...
public interface IEntityAnimator<T extends EntityLiving> {
    IEntityAnimator<EntityLiving> STATIC_ANIMATOR = new IEntityAnimator<EntityLiving>() {
        @Override
     ...
     * @param uLimbSwing        the current limb-swing
     * @param interpolatedSwing the interpolated limb-swing
     * @param uRotfloat         Unknown, just being passed on
     * @param headYaw           the current yaw of the entity
     * @param interpolatedPitch the interpolated pitch

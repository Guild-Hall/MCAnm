...
public class BSplineInterpolation extends Spline {
     ...
     * </ul>
     *
     * @param x1 x value of the left frame
     * @param x2 x value of the right handle of the left frame
     * @param x3 x value of the left handle of the right frame
     * @param x4 x value of the right frame
     * @param x  the frame to evaluate
     * @return
     */
     ...
     *
     * @param y1 y value of the left frame
     * @param y2 y value of the right handle of the left frame
     * @param y3 y value of the left handle of the right frame
     * @param y4 y value of the right frame
     * @param t  t on the curve in [0..1]
